...
import com.test.mycalculator.R;
...
public class KeyboardView extends View {
    ...
    public KeyboardView(Context context, AttributeSet attrs) {
        ...
        calculator = (MyCalculator) context;        
    }
    
    public void init(char[][] keys, boolean isLarge, boolean isBottom) {
        this.keys = keys;
        nLine = keys.length;
        nCol = keys[0].length;
        ...
        for (int line = 0; line < nLine; ++line) {
            ...
            for (int col = 0; col < nCol; ++col) {
                ...
                final int backColor = (('a' <= c && c <= 'z') 
                                       || c == ' ' || c == MyCalculator.PI) ? 0xff404040 :
                    (('0' <= c && c <= '9') || c == '.') ? 0xff303030 :
                    (c == 'E' || c == 'C' || c == MyCalculator.ARROW) ? 0xff306060 : 0xff808080;
                /*
                    (c == '+' || c == '\u2212' || c == '\u00d7' || c == '\u00f7') ? 0xff808080 :
                    0xffb0b0b0;
                */
